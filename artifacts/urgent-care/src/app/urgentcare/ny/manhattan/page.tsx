...
export const metadata: Metadata = {
  title: "Urgent Care in Manhattan, NY — Live Wait Times",
  description:
    "Compare live wait times at urgent care clinics in Manhattan, NY. See how many people are in line before you leave home — X-Ray, COVID Testing & more. No appointment needed.",
};
...
export default async function ManhattanPage({ searchParams }: Props) {
        ...
        <section className="bg-ubie-blue-light border-b border-ubie-blue/10 px-4 py-8">
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
              ...
              <span>/</span>
              <span className="text-ubie-dark font-medium">Manhattan</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold text-ubie-dark">
              Urgent Care in Manhattan, NY
            </h1>
          </div>
        </section>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-1 text-gray-500 flex items-center gap-1">
            ...
            {clinicCards.length > 0
              ...
              : activeService ? `No clinics offering ${activeService} in Manhattan` : "No clinics listed yet"}
          </p>
        </div>
      </section>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {clinicCards.length > 0 ? (
          ...
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-sm mt-1">We&apos;re adding clinics in Manhattan soon. Check back shortly.</p>
          </div>
        )}
